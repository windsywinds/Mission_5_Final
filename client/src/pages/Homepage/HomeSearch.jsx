...
const HomeSearch = () => {
  ...
  return (
    <form
      className="flex flex-col md:flex-row w-[70%]  items-center justify-center md:space-x-4 mb-12"
    ...
    >
      ...
      <div className="flex w-full md:w-auto h-full items-center justify-center py-2">
        <button
          className="bg-[#d70707] text-white text-sm sm:text-md rounded-lg py-1.5 w-[80%] md:w-auto md:px-4"
          type="submit"
        >
          Search
        </button>
