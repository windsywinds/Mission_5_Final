    ...
    <div className="flex flex-col w-[full] items-center justify-center">
      ...
      <div className="w-full flex flex-col bg-black h-full pb-12 text-white items-center justify-center">
        <div className="flex w-full items-center justify-center">
          <h2 className="text-3xl font-semibold py-12 text-left w-[90%]">
        ...
        <div className="w-[90%] flex flex-col items-center justify-center">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
            <div className="bg-[#404040] flex flex-col h-full py-12 items-center text-center gap-y-4 px-4 relative">
              ...
              <p className="text-sm">
                Found a property you're interested in? Book in a time in our
                calendar to arrange for a viewing.
              </p>
            </div>
            ...
            <div className="bg-[#404040] flex flex-col h-full py-12 items-center text-center gap-y-4 px-4 relative">
              ...
              <h4 className="text-lg font-semibold">
                Complete The Tenancy Application
              </h4>
              <p className="text-sm">
                Decided this is the right property? Simply fill in and submit
                you the tenancy application form.
              </p>
            </div>
            ...
            <div className="bg-[#404040] flex flex-col h-full py-12 items-center text-center gap-y-4 px-4 relative">
              ...
              <p className="text-sm">
                Our team will assess whether if this is the right property for
                you. If not, we’ll offer you alternative properties suited to
                your needs.
              </p>
            </div>
            ...
            <div className="bg-[#404040] flex flex-col h-full py-12 items-center px-4 text-center gap-y-4 relative">
              ...
              <p className="text-sm">
                Once your application is successful, simply sign the tenancy
                agreement and congratulation, welcome to your new home.
              </p>
            </div>
          </div>
        </div>
