    ...
    <div className="flex flex-col lg:flex-row w-full bg-black py-12 text-white items-center md:justify-between">
      <div className="flex flex-row w-full px-12 lg:px-0 lg:w-1/2 lg:ml-6 items-center justify-between">
        ...
        <div className="flex flex-col text-center lg:text-left space-y-4">
          <h4 className="flex flex-col text-lg md:text-xl font-bold underline">
            Quick Links
          </h4>
      ...
      >
        <h4 className="text-lg md:text-xl font-bold underline pt-8">
          Contact Us
        </h4>
        <div className="flex flex-col space-y-4 w-full">
          <div className="flex flex-col md:flex-row w-full space-y-4 md:space-y-0 justify-between ">
            <input
              ref={nameRef}
              required
              className="bg-black md:w-[45%] placeholder-white border-b-2 focus:outline-none"
          ...
          <input
            ref={subjectRef}
            required
            className="bg-black placeholder-white border-b-2 focus:outline-none"
            placeholder="Subject"
          ></input>
          <input
            ref={messageRef}
